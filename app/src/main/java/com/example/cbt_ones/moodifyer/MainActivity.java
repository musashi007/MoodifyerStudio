...
import com.example.cbt_ones.moodifyer.fragment.FragmentPlaylist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DialogFragment frag_play = new FragmentPlaylist();
                frag_play.show(getSupportFragmentManager(),"Say What?");
            }
        });
...
//        Snackbar snack = Snackbar.make(viewGroup, "Generating "+value, Snackbar.LENGTH_LONG);
